...
#ifndef soapFileSaverService_H
#define soapFileSaverService_H
#include "soapH.h"

    class SOAP_CMAC FileSaverService : public soap {
      public:
        /// Variables globally declared in file_saver_service.h, if any
        /// Construct a service with new managing context
        FileSaverService();
        /// Copy constructor
        FileSaverService(const FileSaverService&);
        /// Construct service given a managing context
        FileSaverService(const struct soap&);
        /// Construct service given a managing context and endpoint
        FileSaverService(const struct soap&, const char *soap_endpoint_url);
        /// Constructor taking input+output mode flags for the new managing context
        FileSaverService(soap_mode iomode);
        /// Constructor taking input and output mode flags for the new managing context
        FileSaverService(soap_mode imode, soap_mode omode);
        /// Destructor deletes deserialized data and its managing context
        virtual ~FileSaverService();
        /// Delete all deserialized data (with soap_destroy() and soap_end())
        virtual void destroy();
        /// Delete all deserialized data and reset to defaults
        virtual void reset();
        /// Initializer used by constructors
        virtual void FileSaverService_init(soap_mode imode, soap_mode omode);
        /// Return a copy that has a new managing context with the same engine state
        virtual FileSaverService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        FileSaverService& operator=(const FileSaverService&);
        ...
        //
        /// Web service operation 'saveFile' implementation, should return SOAP_OK or error code
        virtual int saveFile(const std::wstring& fileName, const xsd__base64Binary& fileData, enum ns__ErrorCode *errorCode) SOAP_PURE_VIRTUAL;
        //
        /// Web service operation 'loadFile' implementation, should return SOAP_OK or error code
        virtual int loadFile(const std::wstring& fileName, ns__loadFileResponse *response) SOAP_PURE_VIRTUAL;
    };
#endif
